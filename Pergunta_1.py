...
print("Menor valor de faturamento ocorrido em um dia do ano: ", menor_valor_de_faturamento)
print("Maior valor de faturamento ocorrido em um dia do ano: ", maior_valor_de_faturamento)
print("Quantidade de dias com o faturamento superior a média anual: ", quantidade_dias_superiores_da_media)
